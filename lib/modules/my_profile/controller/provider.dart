...
class Provider extends GetConnect{
  ...
  Future<dynamic> getProfile() async{
    ...
    final response = await get('http://ec2-13-235-73-248.ap-south-1.compute.amazonaws.com/api/user/myProfile', headers: {"Content-Type": "application/json","Authorization": "Bearer $token"});
